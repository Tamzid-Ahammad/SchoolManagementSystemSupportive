    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FeeTypeStatus = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicYearMonths", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AcademicYearMonths_AcademicYears_AcademicYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parents_AspNetUsers_FatherId",
                        column: x => x.FatherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Parents_AspNetUsers_MotherId",
                        column: x => x.MotherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DepartmentDesignationId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamScheduleStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentModeDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PaymentDue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AcademicYearMonthId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeePayments_AcademicYearMonths_AcademicYearMonthId",
                        column: x => x.AcademicYearMonthId,
                        principalTable: "AcademicYearMonths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Admissions_Students_StudentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    FeePaymentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternativeTeacherId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routine_ClassSections_ClassSectionId",
                        column: x => x.ClassSectionId,
                        principalTable: "ClassSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Routine_Teachers_AlternativeTeacherId",
                        column: x => x.AlternativeTeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Routine_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicYearMonths_AcademicYearId",
                table: "AcademicYearMonths",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeePayments_AcademicYearMonthId",
                table: "FeePayments",
                column: "AcademicYearMonthId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routine_AlternativeTeacherId",
                table: "Routine",
                column: "AlternativeTeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_Routine_ClassSectionId",
                table: "Routine",
                column: "ClassSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_Routine_TeacherId",
                table: "Routine",
                column: "TeacherId");
